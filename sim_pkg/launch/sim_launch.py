...
def generate_launch_description():
    ...
    path_to_urdf = get_package_share_path('sim_pkg')/'description'/'robot_urdf.xacro'
    ...
    world = os.path.join(
        get_package_share_directory('sim_pkg'), "worlds", "industrial-warehouse.sdf"
    )
    ...
    twist_mux_params = os.path.join(get_package_share_directory('sim_pkg'), 'config', 'twist_mux.yaml')
    twist_mux = Node(
        package='twist_mux',
